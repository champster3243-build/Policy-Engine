...
import { syncToDatabase } from "./services/dbSync.js"; // <-- NEW: Knowledge Graph Sync
 ...
 * * We're using Google's Gemini 2.0 Flash model because:
...
/**
 * COMPLETE JOB RECORD
 * * PURPOSE: Update job status to 'COMPLETED' and store results (JSON Blob)
 */
...
function getGeminiModel(definitionMode, maxTokens) {
  return genAI.getGenerativeModel({
    model: "gemini-2.0-flash", // Using fast model
    generationConfig: { 
